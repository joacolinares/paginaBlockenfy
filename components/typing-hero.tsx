...
export function TypingHero() {
  ...
  const phrases = [
    { text: t("hero.typing_phrase"), color: "text-emerald-400", cursorColor: "bg-emerald-400" },
    { text: t("hero.typing_phrase"), color: "text-blue-400", cursorColor: "bg-blue-400" },
    { text: t("hero.typing_phrase"), color: "text-orange-400", cursorColor: "bg-orange-400" },
  ]

  const baseText = "Blockenfy "
